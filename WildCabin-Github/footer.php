 ...
 <footer class="container">
            <div class="footer row">
                <div class="footer-content">
                    <a href="index.php" class="logo"><img src="img/logotitulo1.png" alt=""></a>
                    <p>P.I. Pla de la Vallonga, Avenida Europa,3<br>03006 - Alicante (Spain) </p>
                    <p>Horario atención al cliente:<br>De lunes a viernes de 8 a 16 horas.</p>
                </div>
                <div>
                    <h3>Páginas:</h3>
                    <ul>
                        <li><a href="index.php">Home</a></li>
                        <li><a href="quienesSomos.php">Quíenes Somos</a></li>
                ...
                <ul>
                    <li><a href="mailto:contacto@wildcabin.es">contacto@wildcabin.es</a></li>
                    <li><a href="tel:+34 965 965 965">+34 965 965 965</a></li>
                    <li><a href="tel:+34 666 965 666">+34 666 965 666</a></li>
                </ul>
            </div>
        </div>
        <p class="copy-right">Copyright &copy; 2024. Wild Cabin</p>
        </footer>
